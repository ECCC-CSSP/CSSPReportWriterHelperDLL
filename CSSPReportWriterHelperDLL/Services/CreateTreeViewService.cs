        ...
        public List<ReportTreeNode> CreateReportBoxModelTypeTreeNodeItem(ReportTreeNode reportTreeNode)
        {
            ...
            else
            {
                return new List<ReportTreeNode>()
                {
                    ...
                    CreateReportTreeNodeItem("Box_Model_Discharge_m3_day", ReportTreeNodeTypeEnum.ReportBoxModelType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
                    ...
                    CreateReportTreeNodeItem("Box_Model_Discharge_Duration_hour", ReportTreeNodeTypeEnum.ReportBoxModelType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
        ...
        public List<ReportTreeNode> CreateReportHydrometricSiteDataTypeTreeNodeItem(ReportTreeNode reportTreeNode)
        {
            ...
            else
            {
                return new List<ReportTreeNode>()
                {
                    ...
                    CreateReportTreeNodeItem("Hydrometric_Site_Data_Discharge_m3_s", ReportTreeNodeTypeEnum.ReportHydrometricSiteDataType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
                    CreateReportTreeNodeItem("Hydrometric_Site_Data_DischargeEntered_m3_s", ReportTreeNodeTypeEnum.ReportHydrometricSiteDataType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
                    CreateReportTreeNodeItem("Hydrometric_Site_Data_Level_m", ReportTreeNodeTypeEnum.ReportHydrometricSiteDataType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
        ...
        public List<ReportTreeNode> CreateReportSubsectorHydrometricSiteDataTypeTreeNodeItem(ReportTreeNode reportTreeNode)
        {
            ...
            else
            {
                return new List<ReportTreeNode>()
                {
                    ...
                    CreateReportTreeNodeItem("Subsector_Hydrometric_Site_Data_Discharge_m3_s", ReportTreeNodeTypeEnum.ReportSubsectorHydrometricSiteDataType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
                    CreateReportTreeNodeItem("Subsector_Hydrometric_Site_Data_DischargeEntered_m3_s", ReportTreeNodeTypeEnum.ReportSubsectorHydrometricSiteDataType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
                    CreateReportTreeNodeItem("Subsector_Hydrometric_Site_Data_Level_m", ReportTreeNodeTypeEnum.ReportSubsectorHydrometricSiteDataType, ReportTreeNodeSubTypeEnum.Field, ReportFieldTypeEnum.NumberWithDecimal),
